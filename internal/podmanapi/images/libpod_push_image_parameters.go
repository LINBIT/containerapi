...
/* LibpodPushImageParams contains all the parameters to send to the API endpoint
   for the libpod push image operation.
...
// WithDefaults hydrates default values in the libpod push image params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodPushImageParams) WithDefaults() *LibpodPushImageParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the libpod push image params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodPushImageParams) SetDefaults() {
	var (
		tLSVerifyDefault = bool(true)
	)

	val := LibpodPushImageParams{
