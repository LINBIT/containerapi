...
/* LibpodImagesImportParams contains all the parameters to send to the API endpoint
   for the libpod images import operation.
...
// WithDefaults hydrates default values in the libpod images import params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodImagesImportParams) WithDefaults() *LibpodImagesImportParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the libpod images import params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodImagesImportParams) SetDefaults() {
...
// bindParamLibpodImagesImport binds the parameter changes
func (o *LibpodImagesImportParams) bindParamChanges(formats strfmt.Registry) []string {
	changesIR := o.Changes
