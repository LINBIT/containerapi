...
/* LibpodSearchImagesParams contains all the parameters to send to the API endpoint
   for the libpod search images operation.
...
// WithDefaults hydrates default values in the libpod search images params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodSearchImagesParams) WithDefaults() *LibpodSearchImagesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the libpod search images params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodSearchImagesParams) SetDefaults() {
