...
/* LibpodImageExistsNoContent describes a response with status code 204, with default header values.
...
/* LibpodImageExistsNotFound describes a response with status code 404, with default header values.
...
/* LibpodImageExistsInternalServerError describes a response with status code 500, with default header values.
