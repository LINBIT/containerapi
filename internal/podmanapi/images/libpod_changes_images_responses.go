...
/* LibpodChangesImagesOK describes a response with status code 200, with default header values.
...
/* LibpodChangesImagesNotFound describes a response with status code 404, with default header values.
...
/* LibpodChangesImagesInternalServerError describes a response with status code 500, with default header values.
