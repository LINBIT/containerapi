...
/* LibpodImagesPullParams contains all the parameters to send to the API endpoint
   for the libpod images pull operation.
...
// WithDefaults hydrates default values in the libpod images pull params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodImagesPullParams) WithDefaults() *LibpodImagesPullParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the libpod images pull params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodImagesPullParams) SetDefaults() {
	var (
		tLSVerifyDefault = bool(true)
	)

	val := LibpodImagesPullParams{
