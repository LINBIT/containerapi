...
/* LibpodPushImageOK describes a response with status code 200, with default header values.
...
/* LibpodPushImageNotFound describes a response with status code 404, with default header values.
...
/* LibpodPushImageInternalServerError describes a response with status code 500, with default header values.
