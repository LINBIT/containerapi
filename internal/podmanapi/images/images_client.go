...
type ClientService interface {
	...
	LibpodImagesPull(params *LibpodImagesPullParams, writer io.Writer) (*LibpodImagesPullOK, error)
...
*/
func (a *Client) LibpodImagesPull(params *LibpodImagesPullParams, writer io.Writer) (*LibpodImagesPullOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
