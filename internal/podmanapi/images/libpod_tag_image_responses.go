...
/* LibpodTagImageCreated describes a response with status code 201, with default header values.
...
/* LibpodTagImageBadRequest describes a response with status code 400, with default header values.
...
/* LibpodTagImageNotFound describes a response with status code 404, with default header values.
...
/* LibpodTagImageConflict describes a response with status code 409, with default header values.
...
/* LibpodTagImageInternalServerError describes a response with status code 500, with default header values.
