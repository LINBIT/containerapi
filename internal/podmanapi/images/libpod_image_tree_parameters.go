...
/* LibpodImageTreeParams contains all the parameters to send to the API endpoint
   for the libpod image tree operation.
...
// WithDefaults hydrates default values in the libpod image tree params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodImageTreeParams) WithDefaults() *LibpodImageTreeParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the libpod image tree params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodImageTreeParams) SetDefaults() {
