...
/* LibpodTagImageParams contains all the parameters to send to the API endpoint
   for the libpod tag image operation.
...
// WithDefaults hydrates default values in the libpod tag image params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodTagImageParams) WithDefaults() *LibpodTagImageParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the libpod tag image params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodTagImageParams) SetDefaults() {
