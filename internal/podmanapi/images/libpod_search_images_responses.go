...
/* LibpodSearchImagesOK describes a response with status code 200, with default header values.
...
/* LibpodSearchImagesInternalServerError describes a response with status code 500, with default header values.
