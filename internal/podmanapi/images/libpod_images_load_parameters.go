...
/* LibpodImagesLoadParams contains all the parameters to send to the API endpoint
   for the libpod images load operation.
...
// WithDefaults hydrates default values in the libpod images load params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodImagesLoadParams) WithDefaults() *LibpodImagesLoadParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the libpod images load params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodImagesLoadParams) SetDefaults() {
