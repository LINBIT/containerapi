...
/* LibpodPingGetParams contains all the parameters to send to the API endpoint
   for the libpod ping get operation.
...
// WithDefaults hydrates default values in the libpod ping get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodPingGetParams) WithDefaults() *LibpodPingGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the libpod ping get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LibpodPingGetParams) SetDefaults() {
